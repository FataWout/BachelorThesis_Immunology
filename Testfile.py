...
from ChosenParameterFitting import fit_parameters, plot_fit, compare_conditions, sensitivity_analysis_all, sensitivity_analysis_all_data, model_accuracy, overall_score
...
#########################################
variations = np.arange(-0.050, 0.051, 0.001)
...
sensitivity_analysis_all("basic", metric="r2", variations=variations)
